				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<p>Examine your eyes and determine the best type of contact lenses for your needs.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="../img/productspics/Daily_Wear_Contacts.png" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
									<h2><a href="blog-single.html">Daily Wear Contacts</a></h2>
									<p class="text">Available in various materials (hydrogels, silicone hydrogels) and replacement schedules (daily, bi- weekly, monthly) for comfortable daily use.</p>
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="../img/productspics/Toric_Lenses.png" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
									<h2><a href="blog-single.html">Toric Lenses</a></h2>
									<p class="text">Precision lenses correcting astigmatism by different refractive powers in different meridians of the lens.</p>
                                    <p class="mt-2" style = "font-weight: bold; font-style: Arial;">P1000-P1200</p>
                                    <div class="date mt-3">Book Now!</div>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="../img/productspics/Progressive_contact_Lenses.png" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
