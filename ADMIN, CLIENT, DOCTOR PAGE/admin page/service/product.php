                                ...
                                <div class="row g-2 mb-2 m-0">
                                    ...
                                    <div class="search-keyword col-12 flex-lg-grow-0 d-flex ms-auto">
                                        <div class="input-group">
                                            <input type="text" name="keyword" id="keyword" placeholder="Search for product.." class="form-control">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 fw-bolder brand-color" id="exampleModalLabel">Add Product</h1>
            ...
            <form id="saveemployee" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label fw-bold mb-1">Product Name:</label>
                        <input type="text" class="form-control" name="name" required>
                    </div>

                  <div class="mb-3">
    <label for="product_category_id" class="form-label fw-bold mb-1">Category:</label>
    <select class="form-select  " id="product_category_id" name="product_category_id" required>
        <option value="" id="product_category_id" name="product_category_id" selected disabled>Select Category</option>
        <?php
        ...
        ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" style="height:2.3em; width: 6em;">Save Product</button>
                </div>
            </form>
            <!-- End of the form -->
        </div>
...
<div class="modal fade" id="employeeEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title brand-color fw-bolder" id="exampleModalLabel">Edit Product</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $selected = ($row['id'] == $current_product_category_id) ? 'selected' : '';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title brand-color fw-bolder" id="exampleModalLabel">View Service</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body" class="form-control">
                ...
                <div class="mb-3">
                    <label for="" class="form-label  fw-bold mb-1">Service Name:</label>
                    <p id="view_name" class="form-control"></p>
                </div>

                <div class="mb-3">
                    <label for="" class="form-label  fw-bold mb-1">Category:</label>
                    <p id="view_product_category_id" class="form-control"></p>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label  fw-bold mb-1">Price:</label>
                ...
                foreach ($query_run as $employee) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Set data-bs-target to the corresponding modal ID -->
