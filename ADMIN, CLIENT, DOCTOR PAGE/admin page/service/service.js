$(document).ready(function() {
    ...
    var table = dataTable;
    var filter = createFilter(table, [1]);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (res.status == 404) {
                    ...
                    $('#service_category_id').val(res.data.service_category_id);
    ...
    $(document).on('submit', '#updateemployee', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                var res = $.parseJSON(response);
                if (res.status == 422) {
                    $("#errorMessageUpdate").text(res.message).removeClass('d-none');
                } else if (res.status == 200) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (res.status == 404) {
                    ...
                    $('#view_service_category_id').text(res.data.service_category_id);
