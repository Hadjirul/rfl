...
if(isset($_POST['delete_employee']))
{
    ...
    $query = "DELETE FROM product_category WHERE id='$employee_id'";
...
if (isset($_POST['update_employee'])) {
    ...
    $query = "UPDATE product_category SET name='$name', description='$description'";
...
if (isset($_GET['employee_id'])) {
    ...
    $query = "SELECT * FROM product_category WHERE id='$employee_id'";
    $query_run = mysqli_query($con, $query);
