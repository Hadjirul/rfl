...
if(isset($_POST['delete_employee']))
{
    ...
    $query = "DELETE FROM product WHERE id='$employee_id'";
...
if (isset($_POST['update_employee'])) {
    ...
    if (!isset($_POST['employee_id'], $_POST['name'], $_POST['product_category_id'], $_POST['price'], $_POST['description'])) {
        $res = [
            'status' => 400,
    ...
    $categoryQuery = "SELECT COUNT(*) as count FROM product_category WHERE id = '$product_category_id'";
    ...
    $query = "UPDATE product SET name='$name', product_category_id='$product_category_id', price='$price', description='$description'";
...
if (isset($_POST['save_employee'])) {
    // Ensure all required fields are present
    if (!isset($_POST['name'], $_POST['product_category_id'], $_POST['price'], $_POST['description'])) {
        $res = [
            'status' => 400,
            'message' => 'Missing required fields',
        ];
    ...
    $query = "INSERT INTO product (name, product_category_id, price, description, picture) 
              VALUES ('$name', '$product_category_id', '$price', '$description', '$picturePath')";
    $query_run = mysqli_query($con, $query);
...
if (isset($_GET['employee_id'])) {
    ...
    $query = "SELECT * FROM product WHERE id='$employee_id'";
    $query_run = mysqli_query($con, $query);
