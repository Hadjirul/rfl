  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
        <img src="<?php echo isset($_SESSION['picture']) ? $_SESSION['picture'] : 'uploads/profile picture.png'; ?>" alt="profile" />
    </a>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.php">Pending</a></li>
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.php">Approved</a></li>
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.php">Completed</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin">
                <div class="row">
                  ...
                  Welcome <?php echo isset($_SESSION['name']) && !empty($_SESSION['name']) ? $_SESSION['name'] : 'Admin'; ?>
                </h3>
    ...
    <script>
      function confirmLogout(event) {
        ...
        if (confirm("Are you sure you want to log out?")) {
          window.location.href = "../../auth/logout.php"; // Redirects to logout if confirmed
        }
      }
      </script>
